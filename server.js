...
async function go() {
  ...
  let client = new MongoClient(
    'mongodb+srv://Moshtafizur:iamravs100@cluster0.cxenf.mongodb.net/TodoApp?retryWrites=true&w=majority'
  );
...
function passwordProtected(req,res,next) {
  ...
  if (req.headers.authorization == 'Basic TW9zaHRhZml6dXI6aWFtcmF2czEwMA==') {
    next();
  } else {
    res.status(401).send(' AUTHINTICATION required');
  }
}
